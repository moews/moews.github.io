...
<!--I'm a problem-driven methodologist with a focus on interdisciplinary research. With a detour through an MSc in Artificial Intelligence from the University of Edinburgh before my doctoral studies, I have also previously worked on financial machine learning in the investment management sector.-->

<!--With a previous detour through a master's degree in AI, I'm also an accredited statistician with the American Statistical Association. Before my doctoral studies, I spent some time in the investment management sector working on the research and development of financial machine learning methods.-->

<!--My research is centred on the development and application of approaches in machine learning, statistical inference and high-performance computing to address current domain challenges in a variety of areas.-->
