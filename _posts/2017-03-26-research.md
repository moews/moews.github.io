...
My research is centred on the development and application of approaches in machine learning, statistical inference and high-performance computing to address domain challenges under the broad umbrella of predictive analytics. Below is a (decidedly non-exhaustive) list of my areas of interest.
...
## Cosmology & astrostatistics (before)
* Cosmological parameter estimation
* Dark matter and galaxy evolution
* Voids and gravity theories
