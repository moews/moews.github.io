...
<br>
My research interests are mostly centered on the intersection of cosmology, astrostatistics and machine learning.

My current projects deal with Bayesian nonparametrics for parallelized and high-dimensional cosmological parameter estimation, with spatial statistics for large-scale structure, with cosmic voids as astronomical laboratories, with deep learning for anomaly detection in surveys, and with hybrid analytic and machine learning frameworks for cosmological simulations. In addition, my research covers topics in computational finance and management science.
