...
My current projects deal with Bayesian nonparametrics for parallelized and high-dimensional cosmological parameter estimation, with spatial statistics for large-scale structure, with cosmic voids as astronomical laboratories, with deep learning for anomaly detection in surveys, and with hybrid analytic and machine learning frameworks for simulations. In addition, my research covers topics in quantitative finance and management science. Below is a (rough) list of my research interests and visits:
