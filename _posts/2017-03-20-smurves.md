...
Since Smurves is on [PyPI](https://pypi.org/), simply type `pip install smurves` in your terminal to install it. This project was developed for Python 3, and the installation process will automatically install any necessary dependencies. Documentation and a quickstart guide on how to use Smurves can be found in the [code repository](https://github.com/moews/smurves) as well as the source code's docstrings.
